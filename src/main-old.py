...
sort_keys = [
    ...
    "result", "results",
    "processingTime", "acceptMirrored", "loops", "heatRequirement", "experience", "cookingtime", "count", "category", "show_notification"
    ]
...
process_data = {
    'minecraft_1.19': {
        'base_whitelist': ['blasting', 'campfire_cooking', 'smelting', 'smoking', 'stonecutting']
        },
    'minecraft_1.20': {
        'base_whitelist': ['blasting', 'campfire_cooking', 'smelting', 'smoking', 'stonecutting', 'crafting_decorated_pot']
        },
    'create': {
